...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean getShiroFilterFactoryBean(@Qualifier("securityManager")DefaultWebSecurityManager securityManager){
        ...
        map.put("/tbSeller/login","anon");
        map.put("/tbSeller/loginOut","anon");
        map.put("/**","user");
        shiroFilterFactoryBean.setLoginUrl("/tbSeller/login");
    ...
    public SimpleCookie simpleCookie(){
        SimpleCookie simpleCookie = new SimpleCookie("lingyunshop-merchant");
